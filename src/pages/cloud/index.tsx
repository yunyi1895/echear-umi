 ...
 * @LastEditTime: 2020-09-28 15:09:43
...
import CsrcChart from './_part/CsrcChart';
const content = (
  <div>
    <p>双击可全屏</p>
  </div>
        ...
        >
          ...
          <div className=" cloud_container">
            ...
            <div className="fx-1 footer_info fx-row">
              <div className="fx-3 fx-column">
                <h3 className="tit">2020年月度股票情况及预测</h3>
                <Trend />
              </div>
              <div className="fx-2  fx-column">
                <h3 className="tit">CSRC行业分类</h3>
                <CsrcChart />
              </div>
            </div>
          </div>
