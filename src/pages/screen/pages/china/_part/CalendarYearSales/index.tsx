/*
 * @Author: your name
 * @Date: 2020-11-13 14:44:21
 * @LastEditTime: 2020-11-13 15:38:36
 * @LastEditors: Please set LastEditors
 * @Description: 中国新能源车历年销量
 * @FilePath: /echear-umi/src/pages/screen/pages/china/_part/CalendarYearSales/index.tsx
 */
...
interface CalendarYearSalesProps {}
const data = [
...
const CalendarYearSales: FC<CalendarYearSalesProps> = props => {
  const {} = props;
  return (
    <Bg1
      titleCn="中国历年新能源车销量（万辆）"
...
export default CalendarYearSales;
